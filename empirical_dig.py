...
datacsv = 'dailySP - 01Jan1990 - 31Dec1994_clean.csv'
...
firmlist['big']= firmlist['PERMCO'].isin(idx_N_biggest_firms(30))   #compute the DI for the 30 biggest firms (using the data of 1000 biggest firms)
